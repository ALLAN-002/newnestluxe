  ...
  return (
    <div className="bg-white p-6 md:p-10 mx-auto max-w-screen-xl">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-3xl md:text-5xl font-bold text-[rgb(27,38,59)] leading-tight">
          Your Path to <br className="hidden md:block" /> Easy Lifestyle
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row justify-center items-stretch gap-6">
        {/* Card 1 */}
        <div className="flex-1 bg-gray-100 rounded-2xl p-8 flex flex-col justify-between text-center md:text-left">
          ...
          <Link to="/Listings">
            <button className="bg-blue-600 text-white text-lg md:text-xl px-6 py-2 rounded-full hover:bg-blue-700 transition hover:animate-pulse">
              Learn more
            </button>
          </Link>
        </div>
      ...
      <div className="mt-16 flex flex-col md:flex-row items-center gap-8">
        <div className="w-full md:w-1/2 max-w-md rounded-3xl overflow-hidden">
          <img src={landscape} alt="landscape" className="w-full h-auto object-cover" />
        </div>
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 text-[rgb(27,38,59)]">
            Wild Escape & Wonder
          </h2>
          <p className="text-[rgba(21,44,70,0.84)] text-lg md:text-2xl leading-relaxed mb-10">
