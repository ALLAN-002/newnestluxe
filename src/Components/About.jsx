    ...
    <div className='bg-gray-100 w-full py-16 px-4 sm:px-6 lg:px-8'>
      <div className="flex flex-col md:flex-row items-center justify-center gap-10 p-6 sm:p-10 max-w-7xl mx-auto bg-white rounded-3xl shadow-lg">
        ...
        <div className="flex-1 max-w-lg text-center md:text-left">
          ...
          <p className="text-base sm:text-lg md:text-xl mb-8 text-gray-800 leading-relaxed">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4 sm:gap-6">
            <Link to="/Listings">
              <button className="bg-blue-600 text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-full hover:bg-blue-700 transition duration-300 font-semibold text-base sm:text-lg">
                Find Your Home
              </button>
            </Link>
